...
import { ThemeToggleButton } from '@/components/admin-ui-ref/common/ThemeToggleButton';
import NotificationDropdown from '@/components/admin-ui-ref/header/NotificationDropdown';
            ...
            <form>
              <div className="relative">
                ...
                <input
                  ...
                  className="dark:bg-dark-900 h-11 w-full rounded-lg border border-gray-200 bg-transparent py-2.5 pr-14 pl-12 text-sm text-gray-800 shadow-theme-xs placeholder:text-gray-400 focus:border-brand-300 focus:ring-3 focus:ring-brand-500/10 focus:outline-hidden xl:w-[430px] dark:border-gray-800 dark:bg-gray-900 dark:bg-white/3 dark:text-white/90 dark:placeholder:text-white/30 dark:focus:border-brand-800"
                />
